...
export interface Scenario {
    ...
    inflation_calibration_preset?: 'US-CPI' | 'UK-CPI' | 'UK-RPI' | 'EU-HICP' | 'Custom';
 ...
 */
export type AssetClassId = 'us_equity' | 'intl_equity' | 'us_bond' | 'intl_bond' | 'reit' | 'commodities' | 'cash' | string;
/**
