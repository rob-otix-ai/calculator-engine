 ...
 */
import { hashSeed, mulberry32, standardNormal } from './return-sampler.js';
/**
 ...
 */
export const INFLATION_CALIBRATION_PRESETS = {
 ...
 */
export function buildInflationSampler(process, seed) {
    if (process.kind === 'Flat') {
        const rate = process.rate_pct / 100;
        return {
            kind: 'Flat',
            sample(_year, _priorInflation) {
                return rate;
            },
        };
    }
